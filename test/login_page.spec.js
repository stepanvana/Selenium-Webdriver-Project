const chai = require("chai"),
    fs = require("fs"),
    expect = chai.expect,
    LoginPage = require("./../lib/pages/login_page"),
...
describe("Login Test", async function () {
    ...
    it("Enter user email address in the email field and check if the field is enabled", async function () {
        let isEnabled = await loginPage.userEmail();
        expect(isEnabled).to.be.true;
    });

    it("Enter user password in the password field and check if the field is enabled", async function () {
